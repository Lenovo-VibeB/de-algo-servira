...
ifneq ($(strip $(wildcard  $(MTK_CGEN_CUSTOM_DIR)/$(HQ_PROJECT)/cgen)),)
MTK_CGEN_custom_cfg_module_file_dir	:= $(MTK_CGEN_CUSTOM_DIR)/$(strip $(HQ_PROJECT))/cgen/cfgfileinc
MTK_CGEN_custom_cfg_default_file_dir	:= $(MTK_CGEN_CUSTOM_DIR)/$(strip $(HQ_PROJECT))/cgen/cfgdefault
else
...
$(warning ---MTK_CGEN_custom_cfg_module_file_dir=$(MTK_CGEN_custom_cfg_module_file_dir)---)
$(warning ---MTK_CGEN_custom_cfg_default_file_dir=$(MTK_CGEN_custom_cfg_default_file_dir)---)
#end
...
#modify by liunianliang begin
ifneq ($(strip $(wildcard  $(MTK_CGEN_CUSTOM_DIR)/$(HQ_PROJECT)/cgen)),)
$(eval $(call mtk-cgen-PreprocessFile,$(MTK_CGEN_APDB_SourceFile),$(MTK_CGEN_AP_Temp_CL),$(MTK_CGEN_COMPILE_OPTION) -I. -I$(MTK_CGEN_CUSTOM_DIR)/$(strip $(HQ_PROJECT))/cgen/inc -I$(MTK_CGEN_CUSTOM_COMMON_DIR)/inc,$$(DEAL_STDOUT_CODEGEN)))
else
