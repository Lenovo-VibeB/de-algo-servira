...
my $hq_default_xml;  #liunianliang
my $hq_client_xml;  #liunianliang
...
=cut
	...
	#add by liunianliang for custom xls begin
	$hq_client_xml = "huaqin/config/$ENV{MTK_PROJECTS}/$ENV{HQ_PROJECT}/$ENV{HQ_CLIENT}/partition_table_$ArgList{PLATFORM}.xls";
	$hq_default_xml= "huaqin/config/$ENV{MTK_PROJECTS}/$ENV{HQ_PROJECT}/default/partition_table_$ArgList{PLATFORM}.xls";
	if(-e $hq_client_xml){
	    $Partition_layout_xls = $hq_client_xml;
	}elsif (-e $hq_default_xml) {
	    $Partition_layout_xls = $hq_default_xml;
	}
	print "xls is $Partition_layout_xls";
	#end	
